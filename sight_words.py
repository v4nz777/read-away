...
class SightWordsPage(MDScreen):
    ...
    def display_sight_words(self,instance):
        if instance.list == self.current_displayed_list:
            ...
            for li in instance.list:
                ...
                file_recorded = f'{li}.wav' in sorted(self.file_directory)
    ...
    def record(self, instance):
        self.sound_file = self.word_on_screen + '.wav'
    ...
    def listen(self,instance):
        path_to_file = f'answers/sight_words/{self.word_on_screen}.wav'

        if platform == 'android':
            path_to_file = f'/storage/emulated/0/pb/answers/sight_words/{self.word_on_screen}.wav'
